                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h5 class="mb-3">Bug Management</h5>
                                                <div class="list-group">
                                                    <a href="{{ route('admin.bugs.unassigned') }}" class="list-group-item list-group-item-action">
                                                        <i data-feather="alert-circle" class="me-2"></i>
                                                        Unassigned Bugs
                                                        @if($unassignedBugsCount > 0)
                                                            <span class="badge bg-danger float-end">{{ $unassignedBugsCount }}</span>
                                                        @endif
                                                    </a>
                                                </div>
                                            </div>
...
<div class="modal fade" id="assignBugModal" tabindex="-1" aria-labelledby="assignBugModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="assignBugModalLabel">Assign Bug to User</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('admin.bugs.assign', ['bug' => $bug]) }}" method="POST">
                @csrf
